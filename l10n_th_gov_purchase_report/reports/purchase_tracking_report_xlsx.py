...
class ReportPurchaseTrackingReportXlsx(models.AbstractModel):
    _name = "report.gov_purchase_tracking_report_xlsx"
    ...
    def _get_ws_params(self, wb, data, objects):
        ...
        ws_params = {
            "ws_name": "Purchase Tracking Report",
            "generate_ws_method": "_purchase_tracking_report",
            "title": "รายงานการติดตามสถานะการจัดซื้อจัดจ้าง",
    ...
    def _render_space_purchase_tracking_report(self, duplicate, line, i):
        ...
        return {
            ...
            "pr_total_cost": pr.estimated_cost or "",
